...
// Filters tray for the courses table: Term, Educator, and Content flag — each a single
// "All"-default dropdown. Selections apply live and surface as tags under the search bar.
